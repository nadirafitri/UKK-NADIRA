...
<body class="bg-light">
    <div class="container vh-100 row justify-content-center align-items-center">
        <div class="card shadow p-3 col-md-3 border p-4 bg-white rounded-4">
            ...
            <a href="login_admin.php" class="text-decoration-none">Login sebagai admin Perpustakaan</a><br>
...
if (isset($_POST['tombol'])) {
    ...
    if ($data) {
        ...
        echo "<script>alert(' ❌Pendaftaran Gagal'); window.location.assign('pendaftaran_anggota.php');</script>";
    }
}
?>