...
<body class="bg-light">
    <div class="vh-100 row justify-content-center align-items-center">
        <form method="post" action="" class="col-md-3 border p-4 bg-white rounded-4">
            ...
            <a href="pendaftaran_anggota.php" class="text-decoration-none">Pendaftaran Anggota Perpustakaan.</a>
        </form>
    </div>
</body>
...
if (isset($_POST['tombol'])) {
    ...
    if (mysqli_num_rows($data) > 0) {
        ...
        echo "<script>alert('Login Gagal, Username / Password Salah'); window.location.assign('login_anggota.php');</script>";
    }
}
?>